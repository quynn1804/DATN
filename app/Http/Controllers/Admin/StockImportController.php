...
class StockImportController extends Controller
{
    ...
    {
        $imports = StockImport::with('user')->where('is_hidden', false)->latest()->paginate(10);
...
{
    $import = StockImport::findOrFail($id);
    $import->is_hidden = true;
    $import->save();

    return redirect()->route('admin.stock-imports.index')->with('success', 'Đã ẩn phiếu nhập thành công.');
}
