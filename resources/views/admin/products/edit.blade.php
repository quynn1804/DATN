                                            ...
                                            @if ($variant->images && is_array($variant->images))
                                                <div class="mt-2">
                                                    @foreach ($variant->images as $img)
                                                        ...
                                                        <input type="hidden"
                                                            name="variants[{{ $index }}][old_images][]"
                                                            value="{{ $img }}">
                                                    @endforeach
                                                </div>
                                            @endif
                                            {{-- <input type="hidden" name="variants[{{ $index }}][old_images][]" value="{{ $img }}"> --}}
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addVariantBtn.addEventListener('click', function() {
                ...
                newVariant.classList.add('variant-item', 'border', 'p-3', 'rounded', 'mb-3', 'bg-white',
                    'shadow-sm');
