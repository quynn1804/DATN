                        ...
                        <div class="order-summary">
                            ...
                            <table class="table table-mini-cart">
                                ...
                                <tfoot>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td colspan="4" id="voucher-code-container">
                                            <div class="d-flex">
                                        ...
                                        <td>
                                            <button id="apply-voucher" class="btn"
                                                style="color: black; margin-top: 0px !important">Áp dụng</button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td colspan="4" id="total-price">
                                            <b class="total-price" data-original="{{ $cartTotal }}">
                                                <span>
                                                    {{ number_format(session('discount_amount') ? $cartTotal - session('discount_amount') : $cartTotal, 0, ',', '.') }}
                                                    VND
                                                </span>
                                            </b>
                                        </td>
                            ...
                            <div class=" payment-methods">
                                ...
                                <div class="form-check">
                                    ...
                                    <div>
                                        <input class="form-check-input" type="radio" name="payment_method" value="momoQr"
                                            id="momoQr" required>
...
@section('script')
    <script>
        ...
        let totalElement = document.querySelector('#total-price b.total-price'); // phần chứa số tiền
        let originalTotalRaw = totalElement.getAttribute('data-original');
        let originalTotal = parseFloat(originalTotalRaw);
            ...
            fetch("{{ route('checkout.applyVoucher') }}", {
                ...
                .then(data => {
                    if (data.success) {
                        alert("Áp dụng mã giảm giá thành công! Giảm: " + data.discount_amount.toLocaleString(
                            'vi-VN') + " VND");
